    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="articles">
                    <a href="#articles">Articles</a>
                                    ...
                                    <ul id="tocify-subheader-articles" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="articles-GETapi-articles">
                                <a href="#articles-GETapi-articles">Get a paginated list of articles with filters.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="articles-GETapi-articles--id-">
                                <a href="#articles-GETapi-articles--id-">Get article details by ID.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-auth-forgot-password">Request a password reset link.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-auth-reset-password">
                                <a href="#authentication-POSTapi-auth-reset-password">Reset the password.</a>
                            </li>
                                ...
                                <a href="#authentication-POSTapi-auth-change-password">Change the authenticated user's password.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-preferences">
                    <a href="#user-preferences">User Preferences</a>
                                    ...
                                    <ul id="tocify-subheader-user-preferences" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="user-preferences-GETapi-preferences">
                                <a href="#user-preferences-GETapi-preferences">Get user preferences.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-preferences-PUTapi-preferences">
                                <a href="#user-preferences-PUTapi-preferences">Update user preferences.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-profile">
                    <a href="#user-profile">User Profile</a>
                                ...
                                <a href="#user-profile-GETapi-user">Get the current authenticated user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-profile-PUTapi-user-feed">
                                <a href="#user-profile-PUTapi-user-feed">Get personalized feed.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>View and search articles.</p>

                                <h2 id="articles-GETapi-articles">Get a paginated list of articles with filters.</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/articles?keyword=consequatur&amp;category=consequatur&amp;source=consequatur&amp;date=consequatur" \
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="keyword"                data-endpoint="GETapi-articles"
               value="consequatur"
               data-component="query">
    <br>
<p>Search term (optional). Example: <code>consequatur</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="category"                data-endpoint="GETapi-articles"
               value="consequatur"
               data-component="query">
    <br>
<p>Category name (optional). Example: <code>consequatur</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Source name (optional). Example: <code>consequatur</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="date"                data-endpoint="GETapi-articles"
               value="consequatur"
               data-component="query">
    <br>
<p>date Format: YYYY-MM-DD (optional). Example: <code>consequatur</code></p>
            </div>
                </form>

                    <h2 id="articles-GETapi-articles--id-">Get article details by ID.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/articles/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the article. Example: <code>17</code></p>
            </div>
                    </form>

                <h1 id="authentication">Authentication</h1>

    <p>APIs for user registration, login, and password resets.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match password. Example: <code>consequatur</code></p>
        </div>
        </form>
...
<p>Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-forgot-password">Request a password reset link.</h2>
...
<p>The user's email. Example: <code>qkunze@example.com</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-reset-password">Reset the password.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email associated with the token. Example: <code>qkunze@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-change-password">Change the authenticated user&#039;s password.</h2>
...
<p>Example: <code>consequatur</code></p>
    ...
    <p>Set and fetch user preferences and personalized feed.</p>

                                <h2 id="user-preferences-GETapi-preferences">Get user preferences.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-preferences-PUTapi-preferences">Update user preferences.</h2>
...
<span id="example-requests-PUTapi-preferences">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-preferences">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-preferences" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-preferences"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-preferences"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-preferences" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-preferences">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-preferences" data-method="PUT"
      data-path="api/preferences"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-preferences', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-preferences"
                    onclick="tryItOut('PUTapi-preferences');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-preferences"
                    onclick="cancelTryOut('PUTapi-preferences');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-preferences"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-preferences"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-preferences"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="preferred_sources"                data-endpoint="PUTapi-preferences"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="preferred_categories"                data-endpoint="PUTapi-preferences"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="preferred_authors"                data-endpoint="PUTapi-preferences"
               value=""
               data-component="body">
    <br>
...
<small>string[]</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sources[0]"                data-endpoint="PUTapi-preferences"
               data-component="body">
        <input type="text" style="display: none"
               name="sources[1]"                data-endpoint="PUTapi-preferences"
               data-component="body">
    <br>
<p>List of source keys.</p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string[]</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="categories[0]"                data-endpoint="PUTapi-preferences"
               data-component="body">
        <input type="text" style="display: none"
               name="categories[1]"                data-endpoint="PUTapi-preferences"
               data-component="body">
    <br>
<p>List of category names.</p>
    ...
    <p>Manage profile and fetch current user.</p>

                                <h2 id="user-profile-GETapi-user">Get the current authenticated user.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-profile-PUTapi-user-feed">Get personalized feed.</h2>
...
<span id="example-requests-PUTapi-user-feed">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/user/feed?page=17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/user/feed"
);
...
<span id="example-responses-PUTapi-user-feed">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-user-feed" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-user-feed"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-user-feed"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-user-feed" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-user-feed">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-user-feed" data-method="PUT"
      data-path="api/user/feed"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-user-feed', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-user-feed"
                    onclick="tryItOut('PUTapi-user-feed');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-user-feed"
                    onclick="cancelTryOut('PUTapi-user-feed');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-user-feed"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-user-feed"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-user-feed"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="PUTapi-user-feed"
               value="17"
               data-component="query">
    <br>
